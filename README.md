...
```sh
git clone https://github.com/khsoh/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
choco install -y neovim git ripgrep wget fd unzip gzip mingw make powershell-core golang python nodejs
```
</details>
